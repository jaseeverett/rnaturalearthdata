...
countries110 <- ne_download(scale=110, type='countries', category='cultural', returnclass = "sf")
map_units110 <- ne_download(scale=110, type='map_units', category='cultural', returnclass = "sf")
sovereignty110 <- ne_download(scale=110, type='sovereignty', category='cultural', returnclass = "sf")

countries50 <- ne_download(scale=50, type='countries', category='cultural', returnclass = "sf")
map_units50 <- ne_download(scale=50, type='map_units', category='cultural', returnclass = "sf")
sovereignty50 <- ne_download(scale=50, type='sovereignty', category='cultural', returnclass = "sf")

states50 <- ne_download(scale=50, type='states', category='cultural', returnclass = "sf")

#points for tiny countries that don't appear in higher res data
#not available for scale 10
tiny_countries110 <- ne_download(scale=110, type='tiny_countries', category='cultural', returnclass = "sf")
#devtools::use_data(tiny_countries110, compress='xz', overwrite=TRUE)

tiny_countries50 <- ne_download(scale=50, type='tiny_countries', category='cultural', returnclass = "sf")
...
coastline50 <- ne_download(scale=50, type='coastline', category='physical', returnclass = "sf")
